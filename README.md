...
`2º semestre/2025`
   ...
   O objetivo é criar um portal prático e confiável que guie a pessoa, passo a passo, sobre o que fazer imediatamente e o que fazer depois em várias situações de crime (roubo, assalto, furto, violência doméstica, abuso sexual, sequestro, invasão residencial etc.). Foco em instruções acionáveis, linguagem simples e acesso rápido em emergência.

## Integrantes

* Gess Rosen Boukoumou Mombo
* Igor Gabriel Rodrigues
* Kaique Ademilson Miranda Furtado Silva
* Lucas Benevenuto Rodrigues
* Luisa de Melo Figueiredo Soares
* Matheus Henrique Pereira dos Santos
* Pedro Enzo Campos Fiel
